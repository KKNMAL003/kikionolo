export const COMPANY = {
  ...
  description: 'Onolo Group combines online retail with wholesale and logistics services, offering a seamless experience for LPG and petroleum product customers.',
  benefits: [
  ...
  services: [
    {
      ...
      description: 'Purchase LPG cylinder refills (9kg, 19kg, 48kg) and deposits via our website, with account management features.'
    },
    {
      title: 'Cylinder Refill and Exchange',
      description: 'LPG refills require an exchange cylinder; otherwise, a deposit is charged (subject to availability).'
    },
    {
      title: 'Wholesale Petroleum Products',
      description: 'We source high-quality diesel, petrol, paraffin, and lubricants from refineries, supplying large volumes across South Africa and SADC countries.'
    },
    {
      title: 'Logistics and Transportation',
      description: 'We transport LPG and petroleum products locally and regionally using four truck horses and four trailer tankers.'
    },
    {
      title: 'Certified Installations',
      description: 'LPG installations are performed by SAQCC-registered installers, ensuring safety and compliance.'
    }
  ],
  paymentInfo: {
    merchantId: '27013965',
